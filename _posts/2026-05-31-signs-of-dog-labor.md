...
- Shivering or trembling (even without being cold)
- Panting and rapid breathing
- Nesting — digging, rearranging, circling
- Vomiting (occasional, not continuous)
- Refusal to eat
- Seeking closeness with you, or the opposite — wanting to be alone

**What you shouldn't see:**
- Active straining or pushing (that's Stage 2)
- Visible contractions (these are internal at Stage 1)
...
<div class="post-cta">
  ...
  <p>Use our Dog Pregnancy Calculator to estimate whelping date and track each week of development.</p>
...
- Nursing all puppies
- Resting between nursing sessions
- Reduced appetite immediately after — should return within 24 hours

**Call your vet if:**
- Heavy bleeding (bright red, soaking through bedding)
- Foul-smelling discharge
- Temperature over 102.5°F or below 99°F after whelping
- Any puppy not nursing or failing to gain weight in the first 24 hours
- Mother refusing to nurse or showing aggression toward puppies
- Signs of eclampsia (muscle tremors, stiffness, anxious panting) — this is a calcium emergency, call immediately
...
- Your dog has been in active labor (straining) for more than 2 hours with no puppy
- A puppy is visibly lodged in the birth canal
- Bright red hemorrhaging
